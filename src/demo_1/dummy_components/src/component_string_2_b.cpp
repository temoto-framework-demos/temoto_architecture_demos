...
void sub0Cb(const std_msgs::String &msg)
{
  ...
  msg_0.data = string_0 + " like it is supposed to, even with updates.";
...
void sub1Cb(const std_msgs::String &msg)
{
  ...
  msg_1.data = string_1 + " properly, even with updates.";
...
{
  ros::init(argc, argv, "component_string_2_b_node");
  ros::NodeHandle nh;
